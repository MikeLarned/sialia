...
class App {
    constructor(options, errorHandler) {
        ...
        if (lodash_1.default.isString(docs[0])) {
            this.service.loadRaw(docs[0])
                .subscribe(options => {
                options.documents = lodash_1.default.map(docs, (doc) => {
                    return { document: doc };
                });
...
const jquery_1 = __webpack_require__(7);
const lodash_1 = __webpack_require__(1);
const blue_button_1 = __webpack_require__(26);
...
module.exports = require("blue-button");
